...
help:
	...
	'      PLAN_ALGO=subgoal|reachability|baseline|dev (expert; reachability=check_ik_batch search; baseline=subgoal w/ routing off [NOT dev-faithful]; dev=verbatim old put_mouse_on_pad expert)' \
