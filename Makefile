...
OUT_DIR ?=
# Expert planner for occluder-visibility: subgoal (default) or reachability (the
# check_ik_batch candidate search merged from 35-occluder-spawn-hamid-A).
PLAN_ALGO ?= subgoal
...
help:
	...
	'      PLAN_ALGO=subgoal|reachability|baseline|dev|hamid (expert; reachability=check_ik_batch search; baseline=subgoal w/ routing off [NOT dev-faithful]; dev=verbatim old put_mouse_on_pad expert; hamid=vendored deployable planner, scene-paired)' \
