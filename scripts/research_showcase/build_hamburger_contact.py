...
MOMENTS=[(122,"Contained Before Contact","The hamburger is inside the microwave while transport remains active."),(123,"Container Contact Established","intentional_contact_with appears between the hamburger and microwave."),(128,"Contact Re-established","The transient object-container contact appears again during transport."),(142,"Release Phase","The hamburger remains contained as the left gripper begins release.")]
C={"target":(40,80,230),"intentional_contact_with":(20,160,20),"destination":(20,160,90),"effector":(170,0,170),"camera":(220,120,20),"action":(0,150,210),"text":(38,38,38),"in":(20,140,20),"contains":(20,160,90),"held_by":(170,0,170),"reachable_by":(0,150,210),"visible_to":(220,120,20)}
...
def edges(root,frame):
 ...
 for rel in ("in","contains","intentional_contact_with"):
