...
# into the loader's expected layout:
#   policy/pi05/checkpoints/pi05_robopro_top_cam_jax/robopro/30000/
#
...
TRAIN_CONFIG=pi05_robopro_top_cam_jax   # registered in src/openpi/training/config.py
MODEL_NAME=robopro                       # subdir under checkpoints/<train_config>/
CHECKPOINT_ID=30000
