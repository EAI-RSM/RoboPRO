...
class PI0:
    ...
    def __init__(self, train_config_name, model_name, checkpoint_id, pi0_step):
        ...
        specified_path = f"policy/pi05_modify/checkpoints/{self.train_config_name}/{self.model_name}/{self.checkpoint_id}/assets/"
        ...
        self.policy = _policy_config.create_trained_policy(
            config,
            f"policy/pi05_modify/checkpoints/{self.train_config_name}/{self.model_name}/{self.checkpoint_id}",
