...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotAlohaDataConfig(
            ...
            repack_transforms=_transforms.Group(inputs=[
                _transforms.RepackTransform({
                    ...
                    "actions": "action",
                    "prompt": "prompt",
                    # Obstacle-attention masks: passed through untouched to Observation.
                    "obstacle_mask": "observation.mask.obstacle",
                    "beta_mask": "observation.mask.beta",
                    "target_mask": "observation.mask.target",
                    "dest_mask": "observation.mask.dest",
                })
            ]),
            base_config=DataConfig(
                prompt_from_task=True,
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            ...
            # Keep freshly-initialized obstacle-attention head params (absent from pi05_base).
            missing_regex=".*(lora|attn_query_head).*",
        ),
        num_train_steps=20_000,
        batch_size=64,
        fsdp_devices=1,
