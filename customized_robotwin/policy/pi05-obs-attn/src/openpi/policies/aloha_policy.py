...
class AlohaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # Obstacle-attention supervision masks (optional): pass through untouched so
        # they reach Observation.from_dict. Kept out of `image` so ResizeImages /
        # Normalize / Tokenize never touch them.
        for mask_key in ("obstacle_mask", "beta_mask", "target_mask", "dest_mask"):
            if mask_key in data:
                inputs[mask_key] = data[mask_key]
